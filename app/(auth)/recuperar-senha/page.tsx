...
export const metadata: Metadata = {
  title: "Recuperar senha — VEXO",
};

/**
 * Não é uma tela do Stitch (o export não tem uma tela dedicada de
 * recuperação de senha, mesma situação já documentada em `/login`) —
 * reaproveita o mesmo cartão/tokens de `/login` e `/cadastro` em vez de
 * inventar um novo visual (prompt Etapa 15 §4/§11).
 */
      ...
      <main className="relative z-10 mx-auto flex w-full max-w-container-max flex-grow items-center justify-center p-margin-mobile md:p-margin-desktop">
        ...
        <div className="relative z-10 w-full max-w-[480px]">
          <div className="mb-10 text-center lg:text-left">
            <h1 className="mb-2 font-headline text-headline-md text-on-surface">Recuperar senha</h1>
